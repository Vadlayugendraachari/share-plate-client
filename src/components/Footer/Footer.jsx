...
const Footer = () => {
    return (
        <footer className="bg-black mt-[8rem]" data-aos="fade-up">
            <div className="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8 lg:pt-20">
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                    ...
                    <div className="col-span-2">
                        <h4 className="font-semibold text-gray-100">Feel Free To Send Message</h4>
                    ...
                    <div className="col-span-4 flex flex-col md:flex-row justify-between">
                        <div className="flex justify-between items-center">
                            <p className="text-sm text-gray-400">© 2023 ARSDEV. All rights reserved.</p>
                        </div>
